    ...
    (function (Api) {
        (function (Reflect) {
            var Type = (function () {
                ...
                Type.qualify = function qualify(ast) {
                    var result = [];
            ...
            var Method = (function () {
                ...
                Method.create = function create(ast) {
                    ...
                    if (ast.returnTypeAnnotation) {
                        result.returns = TypeScript.Api.Reflect.Type.create(ast.returnTypeAnnotation);
                    } else {
                    ...
                    if (ast.extendsList) {
                        if (ast.extendsList.members) {
                            for(var n in ast.extendsList.members) {
                                var named_decl = ast.extendsList.members[n];
                    ...
                    if (ast.implementsList) {
                        if (ast.implementsList.members) {
                            for(var n in ast.implementsList.members) {
                                var named_decl = ast.implementsList.members[n];
