                ...
                Type.create = function (ast) {
                    ...
                    var create_type = function (typeRef) {
                        ...
                        if (typeRef.term.nodeType == TypeScript.NodeType.FunctionDeclaration) {
                            ...
                            type.signature = Reflect.Method.create(typeRef.term);
                        }
    ...
    (function (Api) {
        (function (Reflect) {
            var Script = (function () {
                ...
                Script.load_qualified_names = function (script) {
                    var scope = [];

                    var qualify_module_names = function (module) {
                        if (scope.length > 0)
                            module.fullname = scope.join('.') + '.' + module.name;

                        scope.push(module.name);

                        module.interfaces.forEach(function (obj) {
                            if (scope.length > 0)
                                obj.fullname = scope.join('.') + '.' + obj.name;
                        });
    ...
    (function (Api) {
        (function (Units) {
            var CompiledUnit = (function (_super) {
                ...
                function CompiledUnit(path, content, diagnostics, ast, declaration, sourcemap, script) {
                    _super.call(this, path, content, diagnostics);
    ...
    (function (Api) {
        (function (Compile) {
            var Compiler = (function () {
                function Compiler(languageVersion, moduleTarget, logger) {
                    this.logger = logger;
                    ...
                    settings.codeGenTarget = languageVersion;

                    settings.moduleGenTarget = moduleTarget;
                ...
                Compiler.prototype.emitUnits = function (sourceUnits) {
                    ...
                    var get_sourcemap_source = function (sourceUnitPath, emitter) {
                    ...
                    var get_script_reflection = function (path, ast) {
