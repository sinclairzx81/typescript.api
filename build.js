...
var binder_input_filename      = path.join(src_dir, 'api/binding.ts' );
var binder_output_directory    = bin_dir;
...
function build () {
	...
	tools.builder.build_single([compiler_input_filename], compiler_output_filename , function() {
		  ...
		  console.log('compiling binder');
		  tools.builder.build_modular([binder_input_filename], binder_output_directory, function() {
