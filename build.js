...
var resolver_input_filename     = path.join(src_dir, 'api/resolver.ts' );
...
function build () {
	...
	tools.builder.build_single([resolver_input_filename, compiler_input_filename,  reflect_input_filename], compiler_output_filename , function() {
